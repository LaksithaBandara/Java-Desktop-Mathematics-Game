...
public class Level2 extends javax.swing.JFrame {
     ...
     */
    public Level2(int questionanswered, int marks, String loginname) {
        initComponents();
//        dt();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\laksi\\Desktop\\Projects\\Java\\NetBeans\\06.CIS_Game\\Images\\level2.jpg")); // NOI18N
...
//            questionanswered = questionanswered+1;
            ...
            new Level3(questionanswered,marks,loginname).setVisible(true);
            this.dispose();
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
             ...
             if (jrbtn1.isSelected()){
                    ...
                    lblAnswerStatus.setText("Correct Answer is 124");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Level2(0,0,"").setVisible(true);
            }
        });
    }
